 ...
 * @author caiol
 */
public class ViewportPagamentos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ViewportPagamentos.class.getName());

    /**
     * Creates new form ViewportPagamentos
     */
    public ViewportPagamentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LABELTotal.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewportPagamentos().setVisible(true));
    }
